...
urlpatterns = [
    ...
    path('carpetas/<int:carpeta_id>/subir/', views.subir_archivo_a_carpeta, name='subir_archivo'),    # API
    path('api/preview-sql-estructura/', views.preview_sql_estructura, name='preview_sql_estructura'),
    path('api/preview-sql-conversion/', views.preview_sql_conversion, name='preview_sql_conversion'),
